...
import com.example.ltdd_dacs3.databinding.BillingProductsRvItemBinding
    ...
    inner class BillingProductsViewHolder(val binding: BillingProductsRvItemBinding): ViewHolder(binding.root) {
        ...
        fun bind(billingProduct: CartProduct) {
            binding.apply {
                ...
                tvCartProductSize.text = billingProduct.selectedRatio?:"".also { imageCartProductSize.setImageDrawable(ColorDrawable(Color.TRANSPARENT)) }
            }
        }
