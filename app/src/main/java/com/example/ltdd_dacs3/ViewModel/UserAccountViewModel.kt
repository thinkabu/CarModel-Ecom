...
import com.example.ltdd_dacs3.ThinDwgApplication
...
class UserAccountViewModel @Inject constructor(
    ...
    private val _user = MutableStateFlow<Resource<User>>(Resource.Unspecifiled())
    val user = _user.asStateFlow()

    private val _updateInfo = MutableStateFlow<Resource<User>>(Resource.Unspecifiled())
        ...
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<ThinDwgApplication>().contentResolver,
                    imageUri
                )
